...
private data class AuthConfigResponse(
    ...
    val issuer: String,  // For backwards compatibility
    val audience: String,
...
class AuthConfigRoute(audience: String, domain: String, tokenPath: String, authType: AuthMethod, algorithm: String = "RS256") : Handler<RoutingContext> {
    ...
    private val json: JsonObject = JsonObject.mapFrom(AuthConfigResponse(authType, domain, domain, audience, tokenPath, algorithm))
